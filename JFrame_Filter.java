 ...
 */
public class JFrame_Filter extends javax.swing.JFrame {

    /**
     * Creates new form JFrame_Filter
     */
    public JFrame_Filter() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_Filter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new JFrame_Filter().setVisible(true);
            }
        });
    }
